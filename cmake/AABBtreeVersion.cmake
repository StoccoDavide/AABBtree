function(parse_version_string VERSION_STRING)
  ...
  set(AABBTREE_VERSION ${BASE_VERSION} CACHE INTERNAL "")
  set(AABBTREE_VERSION_PRERELEASE ${PRE_RELEASE} CACHE INTERNAL "")
endfunction()
...
function(write_version_file)
  if(NOT AABBTREE_VERSION)
    message(FATAL_ERROR "AABBTREE_VERSION is not set")
  endif()

  set(VERSION_STRING "${AABBTREE_VERSION}")
  if(AABBTREE_VERSION_PRERELEASE)
    set(VERSION_STRING "${VERSION_STRING}-${AABBTREE_VERSION_PRERELEASE}")
  endif()
